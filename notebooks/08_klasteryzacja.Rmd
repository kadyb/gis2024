...
W kolejnym kroku, używając funkcji `dir.create()` stowrzymy nowy katalog na
...
```{r}
colors = rainbow(4) # wybierz 4 kolory z wbudowanej palety `rainbow`
...
```{r}
colors = c("#9aed2d", "#086209", "#2fbd2f", "#d9d9d9")
category = c("trawa", "lasy/woda", "gęsta roślinność", "odkryta gleba")
...
podejściu pikselowym, co oznacza, że relacje między sąsiadującymi pikselelami nie
...
rozwiązan, np. wykorzystanie większej liczby klastrów lub innego algorymtu
...
oraz redukcji wymiarowośći w przypadku skorelowanych zmiennych.
...
Zwykle jednak model trenowany jest na reprezentatywenj próbie, a następnie
