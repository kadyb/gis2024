---
title: "Przetwarzanie danych przestrzennych"
...
Możemy również wyświetlić ten raster.
...
lub zasięgu zdefiniowanego przy użyciu współrzędnych (*SpatExtent*).
...
1. Z portalu [OpenTopography](https://opentopography.org/) pobierz numeryczny
...
2. Pobierz granice powiatów z Geoportalu, następnie wylicz ich centroidy
i wskaż te powiaty, które są położone najbliżej i najdalej. Wskazówki:

* Obiekt klasy `dist` można przekonwertować do macierzy.
